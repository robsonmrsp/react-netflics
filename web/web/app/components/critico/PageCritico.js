/* Critico´s Search Page generated by JSetup v0.95 :  at 23 de jun de 2021 23:11:05  */
...
export default class PageCritico extends React.Component {
    constructor(props) {
        super(props)
    ...
    create = () => {
        // this.$router.push({ path: "/criticos/new/" });
    }

    editCritico = (_critico) => {
        // this.$router.push({ path: "/criticos/edit/" + _critico.id });
        console.log("editando critico ", _critico);
    }
    ...
    removeCritico = (_critico) => {
        console.log("removendo critico ", _critico);
    }
    ...
    paginate = (pageIndex = 1) => {
        ...
        this.service.getPage(
            ...
            error => {
                console.error("error fetching critico´s page", error);
            }
        );
    }
            ...
            <div >
                <div className="panel">
                    ...
                    <div className="panel-body">
                        <div id="messages_div" />
                        <form id="formCriticoFilter">
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/criticos/new">Novo Registro </NavLink>
                            ...
                            <div className="panel" style={{ display: this.state.showFilter ? "block" : "none" }} >
                                ...
                                <div className="panel-body">
	                                ...
	                                <FormGroup controlId="controlIdEmpresa"  > 
	                                    <ControlLabel>Empresa</ControlLabel>
	                                    <JSInputField name="empresa" type="text" value={this.state.datatableConfig.filterParameters.empresa}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
                                    <div>
                        ...
                        <div className="cente">
                            <div className="table-responsive ">
                                ...
                                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                        {
                                            this.state.datatableConfig.items.map((critico, index) => {
                                                return (
                                                    <tr key={critico.id}>
                                                        <td>{critico.nome}</td>
                                                        <td>{critico.empresa}</td>
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editCritico(critico)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeCritico(critico)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Critico">
