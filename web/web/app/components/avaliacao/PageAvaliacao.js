/* Avaliacao´s Search Page generated by JSetup v0.95 :  at 23 de jun de 2021 23:11:05  */
...
export default class PageAvaliacao extends React.Component {
    ...
    create = () => {
        // this.$router.push({ path: "/avaliacaos/new/" });
    }

    editAvaliacao = (_avaliacao) => {
        // this.$router.push({ path: "/avaliacaos/edit/" + _avaliacao.id });
        console.log("editando avaliacao ", _avaliacao);
    }
    ...
    removeAvaliacao = (_avaliacao) => {
        console.log("removendo avaliacao ", _avaliacao);
    }
    ...
    paginate = (pageIndex = 1) => {
        ...
        this.service.getPage(
            ...
            error => {
                console.error("error fetching avaliacao´s page", error);
            }
        );
    }
            ...
            <div >
                <div className="panel">
                    ...
                    <div className="panel-body">
                        <div id="messages_div" />
                        <form id="formAvaliacaoFilter">
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/avaliacaos/new">Novo Registro </NavLink>
                        ...
                        <div className="cente">
                            <div className="table-responsive ">
                                ...
                                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                        {
                                            this.state.datatableConfig.items.map((avaliacao, index) => {
                                                return (
                                                    <tr key={avaliacao.id}>
                                                        <td>{avaliacao.dataHora}</td>
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editAvaliacao(avaliacao)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeAvaliacao(avaliacao)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Avaliação">
